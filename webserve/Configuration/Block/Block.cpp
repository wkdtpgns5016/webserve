...
void	Block::setClientMaxBodySize(int client_max_body_size) { _client_max_body_size = client_max_body_size; }
...
const int&	Block::getClientMaxBodySize() const { return _client_max_body_size; }
