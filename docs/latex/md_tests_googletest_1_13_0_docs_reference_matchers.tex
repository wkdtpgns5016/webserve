...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md320}{}\doxysection{Wildcard}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md320}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md321}{}\doxysection{Generic Comparison}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md321}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_FpMatchers}{}\doxysection{Floating-\/\+Point Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md322}{}\doxysection{String Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md322}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md323}{}\doxysection{Container Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md323}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T$\ast$ buffer,         int len)} -- see \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_matchers_MultiArgMatchers}{Multi-\/argument Matchers}}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md324}{}\doxysection{Member Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md324}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md325}{}\doxysection{Matching the Result of a Function, Functor, or Callback}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md325}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md326}{}\doxysection{Pointer Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md326}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_MultiArgMatchers}{}\doxysection{Multi-\/argument Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md327}{}\doxysection{Composite Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md327}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md328}{}\doxysection{Adapters for Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md328}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_MatchersAsPredicatesCheat}{}\doxysection{Using Matchers as Predicates}\label{md_tests_googletest_1_13_0_docs_reference_matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md329}{}\doxysection{Defining Matchers}\label{md_tests_googletest_1_13_0_docs_reference_matchers_autotoc_md329}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily MATCHER\+\_\+P(Is\+Divisible\+By, n, \char`\"{}\char`\"{}) \{ $\ast$result\+\_\+listener \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} \char`\"{}where the remainder is \char`\"{} \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} (arg \% n); return (arg \% n) == 0; \}}   &Defines a matcher {\ttfamily Is\+Divisible\+By(n)} to match a number divisible by {\ttfamily n}.    \\\cline{1-2}
{\ttfamily MATCHER\+\_\+\+P2(Is\+Between, a, b, absl\+::\+Str\+Cat(negation ? \char`\"{}isn\textquotesingle{}t\char`\"{} \+: \char`\"{}is\char`\"{}, \char`\"{} between \char`\"{}, Print\+To\+String(a), \char`\"{} and \char`\"{}, Print\+To\+String(b))) \{ return a \texorpdfstring{$<$}{<}= arg \&\& arg \texorpdfstring{$<$}{<}= b; \}}   &Defines a matcher {\ttfamily Is\+Between(a, b)} to match a value in the range \mbox{[}{\ttfamily a}, {\ttfamily b}\mbox{]}.   \\\cline{1-2}
\end{longtabu}
