\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md462}{}\doxysubsubsection{Setup}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md462}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md463}{}\doxysubsection{Build with CMake}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md463}
Google\+Test comes with a CMake build script (\href{https://github.com/google/googletest/blob/main/CMakeLists.txt}{\texttt{ CMake\+Lists.\+txt}}) that can be used on a wide range of platforms (\char`\"{}\+C\char`\"{} stands for cross-\/platform.). If you don\textquotesingle{}t have CMake installed already, you can download it for free from \href{http://www.cmake.org/}{\texttt{ http\+://www.\+cmake.\+org/}}.

CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md464}{}\doxysubsubsection{Standalone CMake Project}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md464}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md465}{}\doxysubsubsection{Incorporating Into An Existing CMake Project}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md465}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md466}{}\doxyparagraph{Visual Studio Dynamic vs Static Runtimes}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md466}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md467}{}\doxysubsubsection{C++ Standard Version}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md467}
An environment that supports C++11 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 11)} command. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the {\ttfamily DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md468}{}\doxysubsection{Tweaking Google\+Test}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md468}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md469}{}\doxysubsection{Multi-\/threaded Tests}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md469}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{https://gcc.gnu.org/wiki/Visibility}{\texttt{ https\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md471}{}\doxysubsection{Avoiding Macro Name Clashes}\label{md_tests_googletest_1_13_0_googletest__r_e_a_d_m_e_autotoc_md471}
