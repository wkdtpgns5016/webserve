\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md293}{}\doxysection{Introduction\+: Why googletest?}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md293}
...
Since googletest is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md294}{}\doxysection{Beware of the nomenclature}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md294}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md295}{}\doxysection{Basic Concepts}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md295}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md296}{}\doxysection{Assertions}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md296}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md297}{}\doxysection{Simple Tests}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md297}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_googletest_1_13_0_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_tests_googletest_1_13_0_docs_primer_same-data-multiple-tests}
...
As an example, let\textquotesingle{}s write tests for a FIFO queue class named {\ttfamily \mbox{\hyperlink{class_queue}{Queue}}}, which has the following interface\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md298}{}\doxysection{Invoking the Tests}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md298}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md299}{}\doxysection{Writing the main() Function}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md299}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_tests_googletest_1_13_0_docs_primer_autotoc_md300}{}\doxysection{Known Limitations}\label{md_tests_googletest_1_13_0_docs_primer_autotoc_md300}
