You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_for_dummies}{the dummy guide}} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md187}{}\doxysection{Creating Mock Classes}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md187}
\mbox{\hyperlink{class_mock}{Mock}} classes are defined as normal classes, using the {\ttfamily MOCK\+\_\+\+METHOD} macro to generate mocked methods. The macro gets 3 or 4 parameters\+:
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md188}{}\doxysubsection{Dealing with unprotected commas}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md188}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md189}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md189}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md190}{}\doxysubsection{Mocking Overloaded Methods}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md190}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md191}{}\doxysubsection{Mocking Class Templates}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md191}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md192}{}\doxysubsection{Mocking Free Functions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md192}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockingNonVirtualMethods}{mocking non-\/virtual methods}}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md193}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md193}
...
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_NiceStrictNaggy}
...
If a method of {\ttfamily mock\+\_\+foo} other than {\ttfamily Do\+This()} is called, you will get a warning. However, if you rewrite your test to use {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} instead, you can suppress the warning\+:
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} is a subclass of {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}}, so it can be used wherever {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}} is accepted.

It also works if {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}}\textquotesingle{}s constructor takes some arguments, as {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} \char`\"{}inherits\char`\"{} {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}}\textquotesingle{}s constructors\+:
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Nice\+Mock} and {\ttfamily Strict\+Mock} only affects {\itshape uninteresting} calls (calls of {\itshape methods} with no expectations); they do not affect {\itshape unexpected} calls (calls of methods with expectations, but they don\textquotesingle{}t match). See \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_uninteresting-vs-unexpected}{Understanding Uninteresting vs Unexpected Calls}}.

There are some caveats though (sadly they are side effects of C++\textquotesingle{}s limitations)\+:


\begin{DoxyEnumerate}
\item {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} and {\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} only work for mock methods defined using the {\ttfamily MOCK\+\_\+\+METHOD} macro {\bfseries{directly}} in the {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}} class. If a mock method is defined in a {\bfseries{base class}} of {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}}, the \char`\"{}nice\char`\"{} or \char`\"{}strict\char`\"{} modifier may not affect it, depending on the compiler. In particular, nesting {\ttfamily Nice\+Mock} and {\ttfamily Strict\+Mock} (e.\+g. {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}Strict\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>} \texorpdfstring{$>$}{>}}) is {\bfseries{not}} supported.
\item {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} and {\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}\mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}\texorpdfstring{$>$}{>}} may not work correctly if the destructor of {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}} is not virtual. We would like to fix this, but it requires cleaning up existing tests.
\end{DoxyEnumerate}

Finally, you should be {\bfseries{very cautious}} about when to use naggy or strict mocks, as they tend to make tests more brittle and harder to maintain. When you refactor your code without changing its externally visible behavior, ideally you shouldn\textquotesingle{}t need to update any tests. If your code interacts with a naggy mock, however, you may start to get spammed with warnings as the result of your change. Worse, if your code interacts with a strict mock, your tests may start to fail and you\textquotesingle{}ll be forced to fix them. Our general recommendation is to use nice mocks (not yet the default) most of the time, use naggy mocks (the current default) when developing or debugging tests, and use strict mocks only as the last resort.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_SimplerInterfaces}{}\doxysubsection{Simplifying the Interface without Breaking Existing Code}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_SimplerInterfaces}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md194}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md194}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_DelegatingToFake}
...
With that, you can use {\ttfamily \mbox{\hyperlink{class_mock_foo}{Mock\+Foo}}} in your tests as usual. Just remember that if you don\textquotesingle{}t explicitly set an action in an {\ttfamily ON\+\_\+\+CALL()} or {\ttfamily EXPECT\+\_\+\+CALL()}, the fake will be called upon to do it.\+:
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md195}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md195}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_DelegatingToFake}{delegating-\/to-\/fake}} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example\+:
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md197}{}\doxysection{Using Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md197}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md198}{}\doxysubsection{Matching Argument Values Exactly}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md198}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md199}{}\doxysubsection{Using Simple Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md199}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md200}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md200}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md201}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md201}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md202}{}\doxysubsection{Using Matchers as Predicates}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md202}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md203}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md203}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md204}{}\doxysubsection{Using Predicates as Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md204}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_matchers}{Matchers Reference}} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md205}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md205}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md206}{}\doxysubsection{Validating a Member of an Object}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md206}
...
What if you want to validate more than one members at the same time? Remember that there are \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}}.
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md207}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md207}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_CustomMatcherClass}{}\doxysubsection{Defining a Custom Matcher Class}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_CustomMatcherClass}
Most matchers can be simply defined using \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewMatchers}{the MATCHER$\ast$ macros}}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md208}{}\doxysubsection{Matching Containers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md208}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md209}{}\doxysubsection{Sharing Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md209}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md210}{}\doxysection{Setting Expectations}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md210}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_UseOnCall}
...
If you are bothered by the \char`\"{}\+Uninteresting mock function call\char`\"{} message printed when a mock method without an {\ttfamily EXPECT\+\_\+\+CALL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily EXPECT\+\_\+\+CALL(...).Times(\+Any\+Number())}. DO NOT suppress it by blindly adding an {\ttfamily EXPECT\+\_\+\+CALL(...)}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md211}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md211}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_DefaultValue}{here}}) or {\ttfamily ON\+\_\+\+CALL()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md212}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md212}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_SimplerInterfaces}{simpler mock interface}} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_SaveArgVerify}{save the values for later verification}}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_for_dummies_OrderedCalls}{}\doxysubsection{Expecting Ordered Calls}\label{md_tests_googletest_1_13_0_docs_gmock_for_dummies_OrderedCalls}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md213}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md213}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md214}{}\doxysection{Using Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md214}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md215}{}\doxysubsection{Returning References from Mock Methods}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md215}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md216}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md216}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md217}{}\doxysubsection{Combining Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md217}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_SaveArgVerify}{}\doxysubsection{Verifying Complex Arguments}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_SaveArgVerify}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md218}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md218}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_tests_googletest_1_13_0_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md219}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md219}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same \char`\"{}later statements take precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md220}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md220}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md221}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md221}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md222}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md222}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md223}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md223}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md224}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md224}
The \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_SelectingArgs}{selecting-\/an-\/action\textquotesingle{}s-\/arguments}} recipe showed us one way to make a mock function and an action with incompatible argument lists fit together. The downside is that wrapping the action in {\ttfamily With\+Args\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}()} can get tedious for people writing the tests.
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md225}{}\doxysubsection{Sharing Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md225}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md226}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md226}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md227}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md227}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md228}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md228}
...
If you are not happy with the default action, you can tweak it as usual; see \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cheat_sheet_OnCall}{Setting Default Actions}}.
...
\DoxyCodeLine{\ \ \ \ .WillOnce(Return(ByMove(std::make\_unique<Buzz>(AccessLevel::kInternal))));}
\DoxyCodeLine{}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md229}{}\doxysubsection{Making the Compilation Faster}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md229}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md230}{}\doxysubsection{Forcing a Verification}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md230}
...
And that\textquotesingle{}s that.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md232}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md232}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md233}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md233}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md234}{}\doxysubsection{Running Tests in Emacs}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md234}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md235}{}\doxysection{Extending g\+Mock}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md235}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewMatchers}
\{\+: .callout .warning\} WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_gmock_cook_book_PureMatchers}{this section}} for more details.
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md238}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md238}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md239}{}\doxysubsection{Legacy Matcher Implementation}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md239}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md240}{}\doxysubsection{Writing New Cardinalities}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md240}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md241}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md241}
...
{\ttfamily args\+\_\+type}   &the type {\ttfamily std\+::tuple\texorpdfstring{$<$}{<}bool, int$\ast$\texorpdfstring{$>$}{>}}    \\\cline{1-2}
{\ttfamily return\+\_\+type}   &the type {\ttfamily int}    \\\cline{1-2}
{\ttfamily function\+\_\+type}   &the type {\ttfamily int(bool, int$\ast$)}   \\\cline{1-2}
\end{longtabu}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md242}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md242}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md243}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md243}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md244}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md244}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md245}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md245}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewMonoActions}
...
An alternative to the {\ttfamily ACTION$\ast$} macros is to implement {\ttfamily \mbox{\hyperlink{classtesting_1_1_action_interface}{testing\+::\+Action\+Interface}}\texorpdfstring{$<$}{<}F\texorpdfstring{$>$}{>}}, where {\ttfamily F} is the type of the mock function in which the action will be used. For example\+:
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md246}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md246}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md247}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_autotoc_md247}
\hypertarget{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md_tests_googletest_1_13_0_docs_gmock_cook_book_MockFunction}
