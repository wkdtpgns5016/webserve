This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily \mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}}.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_macros}{}\doxysection{Macros}\label{md_tests_googletest_1_13_0_docs_reference_mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_MOCK_METHOD}{}\doxysubsection{MOCK\+\_\+\+METHOD}\label{md_tests_googletest_1_13_0_docs_reference_mocking_MOCK_METHOD}
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The expectation will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the expectation behaves as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_matchers}{Matchers Reference}} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md331}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md331}
...
Google\+Test passes all of the arguments as one tuple into the matcher. The parameter $\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast$ must thus be a matcher of type {\ttfamily Matcher\texorpdfstring{$<$}{<}std\+::tuple\texorpdfstring{$<$}{<}A1, ..., An\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>}}, where {\ttfamily A1, ..., An} are the types of the function arguments.
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md332}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md332}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md333}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md333}
{\ttfamily .In\+Sequence(}$\ast${\ttfamily sequences...}$\ast${\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter $\ast${\ttfamily sequences...}$\ast$ is any number of \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_Sequence}{\`{}\+Sequence\`{}}} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_InSequence}{\`{}\+In\+Sequence\`{} class}}.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md334}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md334}
...
The parameter $\ast${\ttfamily expectations...}$\ast$ can be up to five \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} or \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}} objects. The mock function call is expected to occur after all of the given expectations.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md335}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md335}
...
The parameter $\ast${\ttfamily action}$\ast$ represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_actions}{Actions Reference}} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md336}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md336}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md337}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md337}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_ON_CALL}{}\doxysubsection{ON\+\_\+\+CALL}\label{md_tests_googletest_1_13_0_docs_reference_mocking_ON_CALL}
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_matchers}{Matchers Reference}} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md338}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md338}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md339}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md_tests_googletest_1_13_0_docs_reference_mocking_autotoc_md339}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_classes}{}\doxysection{Classes}\label{md_tests_googletest_1_13_0_docs_reference_mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_tests_googletest_1_13_0_docs_reference_mocking_DefaultValue}
{\ttfamily \mbox{\hyperlink{classtesting_1_1_default_value}{testing\+::\+Default\+Value}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
\end{DoxyCode}
\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_NiceMock}{}\doxysubsection{Nice\+Mock}\label{md_tests_googletest_1_13_0_docs_reference_mocking_NiceMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1_nice_mock}{testing\+::\+Nice\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_NaggyMock}{}\doxysubsection{Naggy\+Mock}\label{md_tests_googletest_1_13_0_docs_reference_mocking_NaggyMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1_naggy_mock}{testing\+::\+Naggy\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
\mbox{\hyperlink{class_mock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md_tests_googletest_1_13_0_docs_reference_mocking_StrictMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1_strict_mock}{testing\+::\+Strict\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_Sequence}{}\doxysubsection{Sequence}\label{md_tests_googletest_1_13_0_docs_reference_mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_InSequence}{}\doxysubsection{In\+Sequence}\label{md_tests_googletest_1_13_0_docs_reference_mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_Expectation}{}\doxysubsection{Expectation}\label{md_tests_googletest_1_13_0_docs_reference_mocking_Expectation}
{\ttfamily \+::testing\+::\+Expectation}

Represents a mock function call expectation as created by \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}}\+:
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_tests_googletest_1_13_0_docs_reference_mocking_ExpectationSet}{}\doxysubsection{Expectation\+Set}\label{md_tests_googletest_1_13_0_docs_reference_mocking_ExpectationSet}
{\ttfamily \+::testing\+::\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \mbox{\hyperlink{md_tests_googletest_1_13_0_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} objects to the set\+:
